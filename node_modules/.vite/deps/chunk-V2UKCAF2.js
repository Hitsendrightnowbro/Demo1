import {
  networkSvgMd
} from "./chunk-4GT6E336.js";
import {
  executeSocialLogin
} from "./chunk-KDSNPQT6.js";
import {
  createRef,
  ref
} from "./chunk-FSEITI4P.js";
import {
  classMap,
  ifDefined,
  property,
  state
} from "./chunk-PCSV6HLI.js";
import {
  ConnectorUtil,
  WalletUtil
} from "./chunk-DANYRBCX.js";
import {
  ConstantsUtil as ConstantsUtil4
} from "./chunk-FF44UITQ.js";
import {
  W3mFrameProvider
} from "./chunk-UVITS4PL.js";
import {
  CaipNetworksUtil,
...
WuiTabs.styles = [resetStyles, elementStyles, styles_default7];
__decorate11([
  property({ type: Array })
...
WuiWalletSwitch.styles = [resetStyles, elementStyles, styles_default8];
__decorate12([
  property()
  ...
  labelAndTagTemplate({ address, profileName, label, description, enableButton, buttonType, buttonLabel, buttonVariant, tagVariant, tagLabel, alignItems = "flex-end" }) {
    return html`
      ...
      truncate: profileName ? "end" : "middle"
            ...
            ${tagVariant && tagLabel ? html`<wui-tag variant=${tagVariant} size="xs">${tagLabel}</wui-tag>` : null}
          </wui-flex>

          ${description ? html`<wui-text variant="tiny-500" color="fg-200">${description}</wui-text>` : null}
        </wui-flex>
...
var TABS_PADDING2 = 16;
var TABS_INNER_PADDING = 4;
var UI_CONFIG = {
    ...
    if (tabsEl) {
      const handleTabsResize = () => {
        ...
        if (tabCount > 1) {
          ...
          const totalTabsPadding = TABS_PADDING2 * 2;
...
__decorate24([
  state()
], W3mProfileWalletsView.prototype, "tabWidth", void 0);
...
WuiSwitch.styles = [resetStyles, elementStyles, colorStyles, styles_default20];
__decorate25([
  property({ type: Boolean })
], WuiSwitch.prototype, "checked", void 0);
WuiSwitch = __decorate25([
...
WuiInputElement.styles = [resetStyles, elementStyles, styles_default22];
__decorate27([
  property()
], WuiInputElement.prototype, "icon", void 0);
WuiInputElement = __decorate27([
...
W3mWalletGuide.styles = styles_default33;
__decorate39([
  property()
...
WuiAllWalletsImage.styles = [resetStyles, styles_default34];
__decorate40([
  property({ type: Array })
], WuiAllWalletsImage.prototype, "walletImages", void 0);
WuiAllWalletsImage = __decorate40([
...
WuiListWallet.styles = [resetStyles, elementStyles, styles_default35];
__decorate41([
  property({ type: Array })
...
W3mAllWalletsWidget = __decorate42([
...
W3mConnectAnnouncedWidget = __decorate43([
...
W3mConnectCustomWidget = __decorate44([
...
W3mConnectExternalWidget = __decorate45([
...
W3mConnectFeaturedWidget = __decorate46([
...
W3mConnectInjectedWidget = __decorate47([
...
W3mConnectMultiChainWidget = __decorate48([
...
W3mConnectRecentWidget = __decorate49([
...
W3mConnectRecommendedWidget = __decorate50([
...
W3mConnectWalletConnectWidget = __decorate51([
...
W3mConnectorList.styles = styles_default36;
__decorate52([
  property()
...
W3mWalletLoginList = __decorate53([
...
W3mConnectView.styles = styles_default37;
__decorate54([
  state()
...
WuiCtaButton.styles = [resetStyles, elementStyles, styles_default38];
__decorate55([
  property({ type: Boolean })
...
W3mMobileDownloadLinks.styles = [styles_default39];
__decorate56([
  property({ type: Object })
], W3mMobileDownloadLinks.prototype, "wallet", void 0);
W3mMobileDownloadLinks = __decorate56([
...
W3mConnectingWidget.styles = styles_default40;
__decorate57([
  state()
...
W3mConnectingExternalView = __decorate58([
...
W3mConnectingMultiChainView.styles = styles_default41;
__decorate59([
  state()
], W3mConnectingMultiChainView.prototype, "activeConnector", void 0);
W3mConnectingMultiChainView = __decorate59([
...
W3mConnectingWcView = __decorate67([
...
W3mConnectingWcBasicView = __decorate68([
...
W3mChooseAccountNameView.styles = styles_default43;
__decorate69([
  state()
], W3mChooseAccountNameView.prototype, "loading", void 0);
W3mChooseAccountNameView = __decorate69([
...
W3mWhatIsAWalletView = __decorate73([
...
W3mConnectWalletsView.styles = styles_default44;
__decorate74([
  state()
], W3mConnectWalletsView.prototype, "checked", void 0);
W3mConnectWalletsView = __decorate74([
...
WuiLoadingHexagon.styles = [resetStyles, styles_default45];
WuiLoadingHexagon = __decorate75([
...
W3mNetworkSwitchView.styles = styles_default46;
__decorate76([
  state()
...
W3mNetworkSwitchView = __decorate76([
...
WuiListNetwork.styles = [resetStyles, elementStyles, styles_default47];
__decorate77([
  property()
...
W3mNetworksView.styles = styles_default48;
__decorate78([
  state()
...
W3mSwitchActiveChainView.styles = styles_default49;
__decorate79([
  property()
], W3mSwitchActiveChainView.prototype, "activeChain", void 0);
W3mSwitchActiveChainView = __decorate79([
...
W3mWhatIsANetworkView = __decorate80([
...
W3mUnsupportedChainView.styles = styles_default50;
__decorate81([
  state()
...
W3mUnsupportedChainView = __decorate81([
...
WuiBanner.styles = [resetStyles, elementStyles, styles_default51];
__decorate82([
  property()
...
W3mWalletCompatibleNetworksView.styles = styles_default52;
W3mWalletCompatibleNetworksView = __decorate83([
...
WuiVisualThumbnail.styles = [resetStyles, styles_default53];
__decorate84([
  property()
...
WuiVisualThumbnail = __decorate84([
...
W3mSIWXSignMessageThumbnails.styles = styles_default54;
W3mSIWXSignMessageThumbnails = __decorate85([
...
W3mSIWXSignMessageView = __decorate86([
...
//# sourceMappingURL=chunk-V2UKCAF2.js.map
