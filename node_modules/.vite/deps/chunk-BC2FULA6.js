...
var AppKitBaseClient = class {
  ...
  async initializeUniversalAdapter() {
    ...
    this.universalProvider = this.options.universalProvider ?? await G.init(universalProviderOptions);
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-LQ66T37Q.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-KRUVMSKW.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-L2MV5SJY.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-6G5MA5IP.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-JA6K6PFX.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-HI5QGRBG.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-Q5DTZTW4.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-Q2QQPNFG.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-A4TI447J.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./ui-CTTWC3KD.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-MFZPOYEW.js"),
      import("./w3m-modal-KUOJJPF5.js")
    ]);
  }
};

// node_modules/@reown/appkit/dist/esm/exports/constants.js
var PACKAGE_VERSION = "1.7.18";
...
//# sourceMappingURL=chunk-BC2FULA6.js.map
