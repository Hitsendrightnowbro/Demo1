...
`;var f=function(n,e,s,a){var i=arguments.length,o=i<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,s):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,s,a);else for(var p=n.length-1;p>=0;p--)(l=n[p])&&(o=(i<3?l(o):i>3?l(e,s,o):l(e,s))||o);return i>3&&o&&Object.defineProperty(e,s,o),o};let m=class extends F{constructor(){super(),this.unsubscribe=[],this.amount="",this.tokenSymbol="",this.networkName="",this.exchanges=u.state.exchanges,this.isLoading=u.state.isLoading,this.loadingExchangeId=null,this.connectedWalletInfo=E.state.connectedWalletInfo,this.initializePaymentDetails(),this.unsubscribe.push(u.subscribeKey("exchanges",e=>this.exchanges=e)),this.unsubscribe.push(u.subscribeKey("isLoading",e=>this.isLoading=e)),this.unsubscribe.push(E.subscribe(e=>this.connectedWalletInfo=e.connectedWalletInfo)),u.fetchExchanges()}get isWalletConnected(){return E.state.status==="connected"}render(){return d`
    ...
    `}initializePaymentDetails(){const e=u.getPaymentAsset();this.networkName=e.network,this.tokenSymbol=e.metadata.symbol,this.amount=u.state.amount.toString()}renderPayWithWallet(){return oe(this.networkName)?d`<wui-flex flexDirection="column" gap="s">
      ...
      <wui-separator text="or"></wui-separator>`:d``}renderPaymentHeader(){let e=this.networkName;if(this.networkName){const a=y.getAllRequestedCaipNetworks().find(i=>i.caipNetworkId===this.networkName);a&&(e=a.name)}return d`
...
`;var b=function(n,e,s,a){var i=arguments.length,o=i<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,s):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,s,a);else for(var p=n.length-1;p>=0;p--)(l=n[p])&&(o=(i<3?l(o):i>3?l(e,s,o):l(e,s))||o);return i>3&&o&&Object.defineProperty(e,s,o),o};const we=4e3;let A=class extends F{constructor(){super(),this.loadingMessage="",this.subMessage="",this.paymentState="in-progress",this.paymentState=u.state.isPaymentInProgress?"in-progress":"completed",this.updateMessages(),this.setupSubscription(),this.setupExchangeSubscription()}disconnectedCallback(){clearInterval(this.exchangeSubscription)}render(){return d`
      <wui-flex
